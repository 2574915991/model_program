...
1. 地质时期
   ...
   ![图0](./assets/国际地质年代表.jpg "国际地质年代表")
2. 地层概念
   地层指的是地球历史中某一地质时期形成的、具有共同特征或成因的层状岩石或沉积物。简单来说，就是一层一层叠起来的岩石“书页”，记录了地球的演变历史。
3. 地层分层
   地质年代是核心依据，尤其在地质历史研究中。 确定地层形成的相对或绝对地质年代。（例如：两套相邻地层分别是三叠系地层和侏罗系地层）
<!--update地层概念-->
### 地层构造
1. 褶皱构造
   ...
   2. 分类：
    ...
    ![图1](./assets/背斜和向斜.png "背斜和向斜")
    ![图2](./assets/单斜构造.png "单斜")
   3. 相似褶皱和平行褶皱
...
2. 断层构造
   ...
   ![图6](./assets/断层面.webp "断层面")
   ![图7](./assets/断层滑距和断距.png "断层滑距和断距")
...
![图14](./assets/级射赤平投影图.png "级射赤平投影图")
...
![图15](./assets/极射赤平投影得到吴氏网.png "极射赤平投影得到吴氏网")
